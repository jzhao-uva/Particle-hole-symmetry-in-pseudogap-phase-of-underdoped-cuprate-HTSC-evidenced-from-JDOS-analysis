The three data files for Fig. 1a and Fig. 1b are 2D matrices. Both x-axis and y-axis are from -1 to 1 for the files in Fig. 1a. Both Both x-axis and y-axis are from -2 to 2 for the files in Fig. 1b.
